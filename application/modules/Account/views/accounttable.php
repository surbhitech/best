      ...
      <div class="container	admin_head">
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <h4 class="page-title">Account  Detail	>	Home</h4>
          </div>
        </div>
...
<div class="row">
	   <div class="col-md-12 col-xs-12 col-lg-12 col-xs-12">
		 <section class="account_pro">
	       <div class="container-fluid">
	          <div class="col-xs-12">
                <div class="table-responsive">
				<span class="pull-right"><button class="btn btn-success" id="print_table">Print Table</button></span>
        <table id="datatable" class="table table-striped table-bordered   table-responsive">
		  ...
		  <?php foreach($table_data as $table){
               $expert_cut = round($table->chat_price/100*80);//80%			 
               $profit = round($table->chat_price-$expert_cut);//20%
                 			   ?>
            <tr style="font-size:12px;">
              <td><?php echo $table->QUESTION_ID; ?> </td>
              <td><?php echo $table->PAY_DATE; ?></td>
              <td><?php echo $table->question_datetime; ?> to <?php echo $table->end_date; ?></td>
              <td><span>&#8377;</span> <?php echo $table->chat_price; ?></td>
              <td><span>&#8377;</span><?php echo $expert_cut; ?></td>
              <td></td>
              <td><?php echo date('d-m-Y', strtotime($table->end_date. ' + 5 days')); ?></td>
              <td><span>&#8377;</span><?php echo $profit; ?></td>
              <td><?php echo $table->username."(".$table->usermobile.")"; ?></td>
              <td><?php echo $table->expert_name."(".$table->expert_mobile.")"; ?></td>
              <td></td>
            </tr>
		  <?php } ?>
	<!-- content -->
