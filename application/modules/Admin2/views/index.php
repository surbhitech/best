...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link href="<?php echo base_url(); ?>assets/adminassets/css/font-awesome.min.css" rel="stylesheet">
 ...
 <body>
        ...
        <div class="wrapper-page">
            ...
            <form class="form-horizontal m-t-20" action="<?php echo base_url(); ?>Admin2/login_check" method="post">
