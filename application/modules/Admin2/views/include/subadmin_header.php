                    ...
                    <p class="webname">best advicer  Subadmin</p>
                            ...
                            <li class="dropdown">
                                ...
                                <a class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true">
                                    <img src="<?php echo base_url() ?>assets/images/img1.jpg" alt="user-img" class="" style="height:50px; width:50px;">

                                </a>

                                <ul class="dropdown-menu">

                                   <li><a href="<?php echo base_url() ?>Login/logout_subadmin"><i class="ti-power-off m-r-5"></i> Logout</a></li>
                                </ul>
                            </li>
                        </ul>
