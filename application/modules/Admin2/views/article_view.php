							   ...
							   <section class="myvekar">
									...
									<div class="col-md-6">
									 <div class="form-group clearfix">
												...
												<input type="hidden" id="article_id" name="article_id" value='<?php echo $article_id; ?>' /><input type="hidden" id="base_url" value='<?php echo base_url(); ?>' />
												</form>
                                     </div> 
										<div class="form-group clearfix">
									...
									<a href="<?php echo base_url() ?>Expert/Artical" class="btn btn-default">Back</a>
...
var resizefunc = [];
     ...
     <script src="<?php echo base_url() ?>assets/js/jquery.min.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url() ?>assets/js/article_image_update.js"></script>
