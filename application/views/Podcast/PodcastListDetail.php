...
<div class="fullcontainer">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a href="<?php if($article_no >0){ echo base_url() ?>Podcast/<?php echo $cat_name; ?>/<?php echo $subcat_name2; } else{ echo ""; } ?>" ><?php echo $sub->subcat_name; ?> (<?php print_r($article_no); ?>)</a></li>
			<?php } ?>
