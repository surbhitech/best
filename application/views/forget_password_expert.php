...
<section class="newforget">
 ...
 <?php if($this->session->flashdata('error')){
	   ...
	   <span style="text-align:center; color:red;"id="show_User_reg_msg">	</span>
        <form method="post" action="<?php echo base_url() ?>Advicer/expert_reset_password" class="otp_uexpert">
         <input type='hidden' name='expert_id' value="<?php echo $exp_id = $this->uri->segment('3'); ?>" />
