	...
	<div class="">
		<div class="row">
			<div class="col-md-12">
				<div class="anyquest">
					<ul>
					<li>My Article Podcast	& Videos  </li></ul>
				</div>
			</div>
		</div>
	</div>
...
<div class="videoarti">
<div class="col-md-12	mypodtime">
<div class="settabs">
<ul class="nav nav-tabs cent_exp set_essetial	podcast_time">
<li class="active"><a data-toggle="tab" href="#menu1"> Article</a></li>
<li ><a data-toggle="tab" href="#home1"> Podcast</a></li>
<li ><a data-toggle="tab" href="#home"> Video</a></li>
...
<div class="col-md-12" id="article_edit"></div>
 ...
 <div id="home1" class="tab-pane fade expertvideo"> 
  <section class="userdashboard">
...
<div class="exp_home1">
    ...
    $i=1;
    if($prodcast_detail !=''){
    foreach($prodcast_detail as $prodcast){ 
     $link = base_url()."Podcast/SingleDetail/".$prodcast->cat_name."/".str_replace(" ","-",$prodcast->subcat_name)."/".$prodcast->id; ?>
    <div class="col-md-12">
<div class="row ">	
    <div class="col-md-3 col-sm-4 col-xs-4 settop"><h3 class="topbot">S.No.</h3></div>
    <div class="col-md-7 col-sm-8 col-xs-8 settop"><div class="tell_tavle"><p><?php echo $i; ?>	</p></div>
...
<div class="row ">	
    <div class="col-md-3 col-sm-4 col-xs-4 settop1"><h3 class="topbot">Sub Category </h3></div>
    <div class="col-md-7 col-sm-8 col-xs-8 settop1"><div class="tell_tavle"><p><?php echo $prodcast->subcat_name; ?></p></div>
    </div>
</div>
<div class="row ">	
    <div class="col-md-3 col-sm-4 col-xs-4  settop"><h3 class="topbot">Podcast  Title</h3></div>
    <div class="col-md-7 col-sm-8 col-xs-8   settop"><div class="tell_tavle"><p>	<a href="<?php echo $link; ?>"><?php echo $prodcast->prodcast_title; ?></a></p></div></div>
</div>
<div class="row ">	
    <div class="col-md-3 col-sm-4 col-xs-4 settop1"><h3 class="topbot">Podcast  language</h3></div>
    <div class="col-md-7 col-sm-8 col-xs-8 settop1"><div class="tell_tavle"><p><a href="#" target="_blank"><?php echo $prodcast->prodcast_language; ?></a></p></div>
    </div>
</div>
<div class="row ">	
    <div class="col-md-3 col-sm-4 col-xs-4   settop"><h3 class="topbot">Podcast Date</h3></div>
    <div class="col-md-7 col-sm-8 col-xs-8   settop"><div class="tell_tavle"><p><?php echo rev_datetime($prodcast->created_at); ?></p>	</div></div>
</div>
<br>
 </div>
<?php $i++; } } ?>
