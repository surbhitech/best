...
<div class="header_cat_home">
<p>All Major Consultancies Your Family Needs <span>Under One Roof</span></p>
</div>			
...
SPEAK YOUR QUESTION As A Voice Message in Eng / Hindi On <strong> 9997441515  </strong>& Advicer Will Call Back</span>
</p>
</div>
<!----<div class="col-md-4">
<p class="get_home get_home1 "><strong> Book Live  Phone Consultation 999 744 1515</strong>   
</p>
</div>
<div class="col-md-4">
<p class="get_home">Speak Your Question As A Voice Message In English or Hindi
</p>
</div>
<div class="col-md-4">
<p class="get_home">Experienced Advicer Will Call Back To Answer
</p>
</div>--->
	...
	<div class=" col-sm-9 col-xs-9">
		...
		<div class="all_type_home">			
			...
			<div class="exspeciy exp_small exp_title_home">
				<span class="exp_small1">Language</span>
				<small>
		...
		<source src="<?php //echo $prodcast[0]->file_link; ?>">
			...
			<div class="exspeciy exp_small	exp_title_home">
				...
				<small><img src="https://bestadvicer.com/assets/images/pho.png"> Phone &nbsp;&nbsp;
				<img src="https://bestadvicer.com/assets/images/pho1.png"> Text 
...
<span>In life, we often come across situations when we need personalized assistance from a specialist of a field.We feel like talking to an authorized and experienced expert for that problem. 
Examples can be a common eye strain , a decision to purchase a mobile or submitting resume.</span>
</div>	

<h4> Connect To Helpful & Elite Advicers From  Anywhere, Anytime.</h4>
<div class="need_opin">
<img src="https://bestadvicer.com/assets/images/q1.png"><p> Different consultancies under one roof with a choice
of  text, panel, phone and video chatting options.   </p></div>
<div class="need_opin"><img src="https://bestadvicer.com/assets/images/q2.png"> <p> Lowest price as due to high sale volume.Monthly unlimited query plans available because of one roof model.  </p>
</div>
<div class="need_opin"><img src="https://bestadvicer.com/assets/images/q3.png"><p>  Time saved with operational ease being all in one platform.	Options to  select advicer or just generally submit the query.     </p>
</div>
<div class="need_opin"><img src="https://bestadvicer.com/assets/images/q4.png"> <p> AI integration to answer the human being not just the question. This is possible due to deeper insight.   </p>
</div> 
<div class="need_opin"><img src="https://bestadvicer.com/assets/images/q5.png"> <p> Four step expert Validation process with content submission strategy.  </p>
</div>
</div>
...
<?php $this->load->view('template/home/choose_category.php'); ?>
<!-- question_steps-->
<!-- recent_answers.php-->
<?php $this->load->view('template/home/recent_answers.php'); ?>
<!-- tabbing-->
<?php $this->load->view('template/home/full_main_tabbing.php'); ?>
<!-- hidden part -->
...
<div class="item active">
	<img src="https://bestadvicer.com/assets/images/gokali5.jpg" alt="">
...
<!-- Slide 2  doctor-->
<div class="item ">
	<img src="https://bestadvicer.com/assets/images/gokali2.jpg" alt="">
	<div class="carousel-caption">
...
<!-- Slide 3 low -->
<div class="item ">
	<img src="https://bestadvicer.com/assets/images/gokali4.jpg" alt="">
	<div class="carousel-caption">
...
<!-- Slide 4 tech-->
<div class="item ">
	<img src="https://bestadvicer.com/assets/images/gokali8.jpg" alt="">
	<div class="carousel-caption">
...
<!-- Slide 5 soap-->
<div class="item ">
	<img src="https://bestadvicer.com/assets/images/gokali1.jpg" alt="">
	<div class="carousel-caption">
...
<!-- Slide 6 spirtual---->
<div class="item ">
	<img src="https://bestadvicer.com/assets/images/gokali7.jpg" alt="">
	<div class="carousel-caption">
...
<!-- Slide 7 business---->
<div class="item ">
	<img src="https://bestadvicer.com/assets/images/gokali6.jpg" alt="">
	<div class="carousel-caption">
...
<!-- /Slide8 Lifestyle-->
<div class="item ">
	<img src="https://bestadvicer.com/assets/images/gokali3.jpg" alt="">
	<div class="carousel-caption">
...
<div class="item ">
	<img src="https://bestadvicer.com/assets/images/gokali3a.jpg" alt="">
	<div class="carousel-caption">
					...
					<div id="owl-demo_expert" class="owl-carousel owl-theme owl-new-carl owl-sildet">
						<div class="item ite-mazon">
							...
							<div class="col-xs-3 col-sm-4">
								<div class="peciali">
									<img src="https://bestadvicer.com/./assets/expert/images/image_99.jpg" style="">
						...
						<div class="item ite-mazon">
							...
							<div class="col-xs-3 col-sm-4">
								<div class="peciali">
									<img src="https://bestadvicer.com/assets/expert/images/image_90.jpg">
									<span> <i class="fa fa-star" aria-hidden="true"></i>
						<i class="fa fa-star" aria-hidden="true"></i>
						<i class="fa fa-star" aria-hidden="true"></i>
	...
	<div class="full_rate">
		...
		<div class="col-md-4 ">
			<div class="full_pricing">
				...
				<!---<a href="https://bestadvicer.com/Advicer">Start free</a>--->
...
<p><img src="https://bestadvicer.com/assets/images/q1.png"> Different consultancies under one roof with a choice
of  text panel phone and video chatting options.   </p>
<p><img src="https://bestadvicer.com/assets/images/q2.png">  Lowest price as due to high sale volume.Monthly unlimited query plans available because of one roof model.  </p>
<p><img src="https://bestadvicer.com/assets/images/q3.png">  Time saved with operational ease being all in one platform.	Options to  select advicer or just generally submit the query.     </p>
<p><img src="https://bestadvicer.com/assets/images/q4.png">  AI integration to answer the human being not just the question. This is possible due to deeper insight.   </p>
<p><img src="https://bestadvicer.com/assets/images/q5.png">  Four step expert Validation process with content submission strategy.  </p>
</div>
