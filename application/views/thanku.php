        ...
        <div class="container">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-left">
							<div class="skills">
						<p class="whymentor-center">Thank you for registration .  <br>
We have sent you an email with your username and password for your record . It also has link for the next step to be taken for profile submission.<br>
