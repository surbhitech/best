...
<div class="header-popup">
	<h6>How Will You Like To Communicate ?</h6>
	<div class="choose_tab">

		<div class="vertical-tab" role="tabpanel">
			<!-- Nav tabs -->
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab">TEXT</a></li>
...
<p>OR</p>
<a href="https://bestadvicer.com/Advicers">Browse Profiles To Select An Advicer</a>
</div>
