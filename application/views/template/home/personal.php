	...
	<div class="row">
		...
		<!-----1------>
		<div id="owl-demopodcat10" class="owl-carousel owl-theme owl-new-carl owl-sildet">
<?php $prodcast = prodcast_detail_all("8");
       foreach($prodcast as $prow){
			...
			<div class="item ite-mazon vedeo_arti_exp">
				...
				<div class="file_catgroy">
					<a href="<?php echo base_url() ?>Podcast/SingleDetail/Wellbing/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>"><?php echo $prow->subcat_name; ?></a>
				</div>
