...
<div class="container-fluid">
	<div class="row" style="">
		...
		<h1><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url() ?>assets/images/logo-tellme.png"></a></h1>
		<div class="nytime">
			...
			<div class="navmaheadd">
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1" style="float:right;">
						...
						<?php } ?>
						<li><a href="<?php echo base_url(); ?>Expert"> Advicers</a></li>
						...
						<li><a href="<?php echo base_url(); ?>Support">Support</a></li>
						 ...
						 <?php if(!empty($this->session->userdata('expert_data'))){ ?>
						    <li><a href="<?php echo base_url(); ?>Expert/profile">Advicer DASHBOARD</a></li>
						    <?php } else { ?>
						    <li><a href="<?php echo base_url(); ?>Expert/Signup">Advicers signIn/Up</a></li>
						    <?php } ?>
