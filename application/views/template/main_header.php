...
<div class="testig"><img src="<?php echo base_url() ?>assets/images/testig.png"></div>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1" style="float:right;">
						<ul class="nav navbar-nav list-inline">
						    ...
						    <li><a href="<?php echo base_url(); ?>User/Dashboard">User Dashboard</a></li>
						    <?php } else { ?>
						<li><a href="<?php echo base_url(); ?>User">User  sign In/Up </a></li>
						<?php } ?>
						<li><a href="<?php echo base_url(); ?>Expert">Select Advicer</a></li>
