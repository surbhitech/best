			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php //print_r($data); ?>					
						...
						<p><strong>Duration:</strong>	<a href="#"><?php echo rev_date($data['question_datetime'])." To ". rev_date($data['end_date']); ?></p>
					</div>
				</div>
			</div>
		</div>
...
<?php $no_row = total_question_row_groupchat($data['user_id'],$data['subcat_id'],$data['expert_id'],encrypt_decrypt('decrypt',$this->uri->segment('2')),$this->uri->segment('4'));
...
<div class="star-rating" style=""><?php expert_review($data['expert_id']); ?>	</div>
</div>
</div>	</div>	</div>	</div>	</div>	
<ul class="lawyer-answer-buttons">	
<li>
...
<div class="lawyer-badge-stars">	
<div class="line rating-counter">	
<div class="star-rating" style=""><?php $total_rating = total_rating($expertrow->expert_id);
