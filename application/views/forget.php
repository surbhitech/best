                  ...
                  <?php if($this->session->flashdata('success')){ ?>
                   <div class="alert alert-success" role="success" style='font-size:15px;'>
                       <i class="fa fa-check" aria-hidden="true"></i> &nbsp;
                        ...
                        <span> &nbsp; <b><a href='<?php echo base_url() ?>Advicer'>Click Here To Login</a></b></span>
                  </div>
                  <?php } ?>
	   <span style="text-align:center; color:red;"id="show_User_reg_msg">	</span>
        <form method="post" action="<?php echo base_url() ?>Advicer/forget_pass" class="otp_uexpert">
