	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php foreach($subcategory as $sub){
                   $article_no = podcast_insubcatwise($sub->subcat_id);
				...
				?>
				<li style="<?php if($article_no>0){ echo "background:green !important"; } ?>">
			<a href="<?php if($article_no >0){ echo base_url() ?>Podcast/<?php echo $cat_name; ?>/<?php echo $subcat_name2; } else{ echo ""; } ?>" >
			<img src="<?php echo base_url(); ?>assets/images/pod.png"class="podlist"style="display: block;margin: auto;"><?php echo $sub->subcat_name; ?> (<?php print_r($article_no); ?>)
				</a></li>
			<?php } ?>
