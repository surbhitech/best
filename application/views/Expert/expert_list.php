...
<div class="container">
  ...
  if($cat_id =='1' or $cat_id =='2' or $cat_id =='5' or $cat_id =='6' or $cat_id =='7' or $cat_id =='9' ){ $advicer = "Advicers"; } 
		...
		?>
<h2> <a href="<?php echo base_url(); ?>">bestadvicer</a> > <a href="<?php echo base_url(); ?>Advicers">
...
<a href=""> <?php echo $row2->subcat_name; } ?></a> </h2>
 <ul>
     <?php if($expert !=''){
         ...
         <?php $expert_name = single_expert($row->expert_id);
       		   $expert_name =  $expert_name[0]->expert_name;
               $expertname2 = preg_replace('/\s+/', '-', $expert_name); 
               $subcat_name = str_replace(' ','-',$subcat_name);                ?>
          <li> <a href="<?php echo base_url(); ?><?php echo $cat_name; ?>/<?php print_r($subcat_name); ?>/<?php echo $expertname2; ?>"> 
          <?php $expert_name = single_expert($row->expert_id);  echo $expert_name[0]->expert_name; ?> </a></li>
          <?php
     } } else{
         ?>
         <li> <a href='<?php echo base_url() ?>Advicers'> No Record Found In This Subcat..... </a></li>;
         <?php
     } } else{
          ?>
           <li> <a href=""> No Record Found In This Subcat..... </a></li>
          <?php
     } ?>
 </ul>
</div>
