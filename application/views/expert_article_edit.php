...
<div class="row">
<div class="col-md-12">
<form action="<?php echo base_url() ?>Advicer/article_update" method="post" enctype="multipart/form-data">
    <div class="artuupad">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
  <label for="sel1"></label>
   ...
   <!-- <option value=''>Sub Category</option> !-->
     <?php $subcat_id = $this->Main_model->allsubcat_in_expert($expert_id);
            foreach($subcat_id as $sub_id){
				 
				$subcat_name = $this->Main_model->subcat_data_single($sub_id->expert_subcat_id);
				?>
				<option value='<?php echo $sub_id->expert_subcat_id; ?>'><?php echo $subcat_name[0]->subcat_name; ?></option>
				<?php
			} 
	...
	<div class="artuupad">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <input type="text" class="form-control" id="usr" name="article_title" value="<?php echo$article_detail[0]->article_title; ?>">
                </div>
            </div>
        </div>
    </div>
...
<div class="col-lg-10">
 <div class="form-group">
  <textarea class="form-control required ckeditor" name="article_comment" ><?php echo$article_detail[0]->article_comment; ?></textarea>
</div>
</div>
</div>    
</div>    
...
<input type='hidden' name='article_id' value='<?php echo $article_detail[0]->article_id; ?>' />
    <div class="col-md-10">
        <div class="subvttd">
            <button type="submit" name="submit">Submit</button>
        </div>
