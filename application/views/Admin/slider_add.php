      ...
      <div class="container	admin_head">
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <h4 class="page-title">Add Slider > Home</h4>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <form action="<?php echo base_url(); ?>Admin/ExpertSlider/Submitslider" method="post" enctype="multipart/form-data">
                <input type="hidden" name="slider_status" id="slider_status" value="1" />
