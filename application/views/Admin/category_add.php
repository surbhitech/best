                    ...
                    <div class="container admin_head">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card-box">
                                    <form role="form" action="<?php echo base_url() ?>Admin/Category/insert_record" method="post" enctype="multipart/form-data">
                                        <div>
                                            <section>
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="form-group clearfix">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <input type="text" class="form-control required" name="cat_title" value="" required>
                                                        </div>
                                                    </div>
													<div class="form-group clearfix">
                                                        <label class="col-lg-2 control-label " for="userName">SubcatCategory View Per Column</label>
                                                        <div class="col-lg-3">
                                                            <input type="text" class="form-control required" name="subcat_view_no" value="" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group clearfix">
