          ...
          <div class="col-md-12">
            ...
            <div class="card-box aplhanewclass">
              ...
              <div class="row">
                ...
                <div class="col-md-3"> <a href="<?php echo base_url() ?>Admin/Subcategory/add"  class="btn btn-default" style="float:right">Add New Record</a> </div>
            ...
            <div class="card-box	expert-fot">
              ...
              <div>
                ...
                <section>
                  ...
                  <?php $cat_name =  cat_name_withsubcat($subadmin[0]->admin_cat_id);
			 ...
			 <div class="form-group clearfix">
                  ...
                  <div class="form-group clearfix">
                   ...
                   <?php } ?>
                  <a  href="<?php echo base_url() ?>Admin/Subcategory"  class="btn btn-default" >Back</a> </section>
