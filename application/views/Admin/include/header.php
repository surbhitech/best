...
<div class="topbar">
	...
	<div class="navbar navbar-default admin_top" role="navigation">
       ...
       <?php if($this->session->userdata('sess_data')){ ?>
							<li><a href="<?php echo base_url(); ?>Admin/Login/change_pass"><i class="ti-user m-r-5"></i>Change Password</a></li>
							<li><a href="<?php echo base_url(); ?>Admin/Login/logout_admin"><i class="ti-power-off m-r-5"></i> Logout</a></li>
							<?php } ?>
					<li>
