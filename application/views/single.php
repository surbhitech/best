	...
	<div class="col-md-6 col-sm-6">
		<div class="row">
		   <div class="expertimg">
			...
			if($expert_award_row !=''){ ?>
		<div class="exspeciy specil_exp1">
			<samp><span>Career Highlights </span><?php $i=0; foreach($expert_award_row as $award){
										$award_name[$i] = $award->award_name;
										$i= $i+1; }
			  echo "<small>".$award_name = implode(",",$award_name)."</small>";	?> </samp>
		</div>
		<?php } ?>
...
<div class="col-md-6 col-sm-6 padding1">
    <?php if(count($prodcast)>0){ ?>
				<div class="exspeciy specil_exp1">
					<span><?=$prodcast[0]['prodcast_title']; ?></span><small> </small>
				</div>
		
				<div class="exspeciy specil_exp1">

				<span class="sinpodcast_pro">	
					<audio controls>
					 <source src="<?=$prodcast[0]['file_link']; ?>" type="audio/mpeg">
				    </audio>
				</span>
				<samp  class="podcast_pro">			
					<span class="inhalt">
					  <svg class="one" viewBox="0 0 100 100">
						<g class="heartOne">
						  <path  class="heartEX" d="M 90,40 a 20 20 0 1 0 -40,-25 a 20 20 0 1 0 -40,25 l 40,50  z" />
						  <path onclick="prodcast_likers('<?php echo $prodcast[0]['id']; ?>')" class="heart" d="M 90,40 a 20 20 0 1 0 -40,-25 a 20 20 0 1 0 -40,25 l 40,50  z" />
						</g>
					  </svg><span id="like_num_prodcast"><?php echo $prodcast[0]['likers']; ?></span>
								...
								<a href="<?php echo base_url() ?>Article/Detail/<?php echo $cat_name; ?>/<?php echo  $subcat_name3; ?>/<?php echo $article->article_id; ?>">
									...
									<div class="hdwrapss">
                                      <?php if($article->article_image_link !=''){ ?>
										...
										<?php } else{ ?>
										<img src="<?php echo base_url(); ?>assets/images/icon2.png" class="hi-icon fa-cubes" >
										<?php } ?>
