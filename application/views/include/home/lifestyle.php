<div id="tell<?php echo "9"; ?>" class="tab-pane fade">
...
<div class="row">
	<div class="col-md-12 ">
		...
		1------>
		<div id="owl-demo54" class="owl-carousel owl-theme owl-new-carl owl-sildet">
			<?php  $expert_detail = expert_detail_incatid("9");
				   $cat_name = cat_name("9");
...
<!----------------recect_video--------------------->
<?php $prodcast = prodcast_detail_all("9");
  if($prodcast !=''){ ?>
...
<!-----1------>
<div id="owl-demopodcat9" class="owl-carousel owl-theme owl-new-carl owl-sildet">
<?php $prodcast = prodcast_detail_all("9");
...
<div class="item ite-mazon vedeo_arti_exp">
	<div class="podcast_imges_full">			
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Lifestyle/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>">
	...
	<div class="file_catgroy">
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Lifestyle/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>"><?php echo $prow->prodcast_title; ?></a>
	</div>
	...
	<div class="podcast_love">
		...
		<div class="pull-right">
			<div class="follr">
                ...
                <label for="heart9"><i class="fa fa-heart-o" aria-hidden="true"></i> <span>0</span></label>
            </div>
		</div>
</div>
...
<div class="">
<a href="<?php echo base_url() ?>Podcast/PodcastList/Lifestyle" class="yesdo1">View	More</a>
</div>
...
<div class="row">
	<div class="col-md-12 ">
		...
		<!-----1------>
		<div id="owl-demo56" class="owl-carousel owl-theme owl-new-carl owl-sildet">
		<?php $expert_article = article_detail("9");
		  if($expert_article !=''){
