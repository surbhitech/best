<div id="tell<?php echo "6"; ?>" class="tab-pane fade">
...
<div class="row">
	...
	<!-----	<div class=" background1">
		...
		1------>
		<div id="owl-demo57" class="owl-carousel owl-theme owl-new-carl owl-sildet">
			<?php  $expert_detail = expert_detail_incatid(6);
				   $cat_name = cat_name("6");
...
<?php $prodcast = prodcast_detail_all("6");
  if($prodcast !=''){ ?>
...
<!-----1------>
<div id="owl-demopodcat7" class="owl-carousel owl-theme owl-new-carl owl-sildet">
<?php $prodcast = prodcast_detail_all("6");
...
<div class="item ite-mazon vedeo_arti_exp">
	<div class="podcast_imges_full">			
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Spiritual/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>">
	...
	<div class="file_catgroy">
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Spiritual/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>"><?php echo $prow->prodcast_title; ?></a>
	...
	<div class="podcast_love">
		...
		<div class="pull-right">
			<div class="follr">
                ...
                <label for="heart6"><i class="fa fa-heart-o" aria-hidden="true"></i> <span>0</span></label>
            </div>
		</div>
</div>
...
<div class="row">
	<div class="col-md-12 ">
		...
		<!-----1------>
		<div id="owl-demo58" class="owl-carousel owl-theme owl-new-carl owl-sildet">
		<?php $expert_article = article_detail("6");
		  if($expert_article !=''){
