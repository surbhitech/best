<div id="tell<?php echo "8"; ?>" class="tab-pane fade">
...
<div class="row">
	<div class="col-md-12 ">
		...
		1------>
		<div id="owl-demo51" class="owl-carousel owl-theme owl-new-carl owl-sildet">
			<?php  $expert_detail = expert_detail_incatid("8");
				   $cat_name = cat_name("8");
...
<!----------------recect_video--------------------->
<?php $prodcast = prodcast_detail_all("8");
  if($prodcast !=''){ ?>
...
<!-----1------>
<div id="owl-demopodcat12" class="owl-carousel owl-theme owl-new-carl owl-sildet">
<?php $prodcast = prodcast_detail_all("8");
...
<div class="item ite-mazon vedeo_arti_exp">
	<div class="podcast_imges_full">			
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Wellbing/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>">
	...
	<div class="file_catgroy">
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Wellbing/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>"><?php echo $prow->prodcast_title; ?></a>
	</div>
	...
	<div class="podcast_love">
		...
		<div class="pull-right">
			<div class="follr">
                ...
                <label for="heart8"><i class="fa fa-heart-o" aria-hidden="true"></i> <span>0</span></label>
            </div>
		</div>
</div>
...
<div class="">
<a href="<?php echo base_url() ?>Podcast/PodcastList/Wellbing" class="yesdo1">View	More</a>
</div>
...
<div class="row">
	<div class="col-md-12 ">
		...
		<!-----1------>
		<div id="owl-demo53" class="owl-carousel owl-theme owl-new-carl owl-sildet">
		<?php $expert_article = article_detail("8");
		  if($expert_article !=''){
