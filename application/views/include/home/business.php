<div id="tell<?php echo "7"; ?>" class="tab-pane fade">
<section class="recect_video3 ">
<div class="row">
	<div class="col-md-12 ">
		<div id="owl-demo48" class="owl-carousel owl-theme owl-new-carl owl-sildet">
			<?php  $expert_detail = expert_detail_incatid("7");
				   $cat_name = cat_name("7");
...
<?php $prodcast = prodcast_detail_all("7");
 if($prodcast ==""){ $prodcast=array(); }
  if(count($prodcast)>0){ ?>
...
<!-----1------>
<div id="owl-demopodcat11" class="owl-carousel owl-theme owl-new-carl owl-sildet">
<?php $prodcast = prodcast_detail_all("7");
...
<div class="item ite-mazon vedeo_arti_exp">
	...
	<a href="<?php echo base_url() ?>Podcast/SingleDetail/Business/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>">
	...
	<div class="file_catgroy ">
		<a href="<?php echo base_url() ?>Prodcast/Detail/Business/<?php echo $cat_name; ?>/<?php echo  $subcat_name3; ?>/<?php echo $prow->id; ?>"><?php echo $prow->prodcast_title; ?></a>
	</div>
	<div class="podcast_imges">			
		<a href="<?php echo base_url() ?>podcast_list_details.php">
	...
	<div class="podcast_love">
		...
		<div class="pull-right">
			<div class="follr">
                ...
                <label for="heart7"><i class="fa fa-heart-o" aria-hidden="true"></i> <span>0</span></label>
            </div>
		</div>
</div>
...
<a href="<?php echo base_url() ?>Podcast/PodcastList/business" class="yesdo1">View	More</a>
...
<div class="row">
	<div class="col-md-12 ">
		...
		<!-----1------>
		<div id="owl-demo50" class="owl-carousel owl-theme owl-new-carl owl-sildet">
		<?php $expert_article = article_detail("7");
		  if($expert_article !=''){
...
<div class="item ite-mazon vedeo_arti_exp">
	<div class="podcast_imges_full">			
		<a href="podcast_list_details.php">
	...
	<div class="file_catgroy ">
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Business/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>"><?php echo $prow->prodcast_title; ?></a>
	   <span class="pull-left"></span><span class="pull-right">Language :<?php echo $prow->prodcast_language; ?></span>
	</div>
	<div class="podcast_imges">			
		<a href="<?php echo base_url() ?>podcast_list_details.php">
