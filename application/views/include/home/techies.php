<div id="tell<?php echo "4"; ?>" class="tab-pane fade">
<section class="recect_video3 ">
<div class="row">
	<div class="col-md-12">
		<div id="owl-demo39" class="owl-carousel owl-theme owl-new-carl owl-sildet">
			<?php  $expert_detail = expert_detail_incatid("4");
				   $cat_name = cat_name("4");
...
<?php $prodcast = prodcast_detail_all("4");
  if($prodcast !=''){ ?>
...
<!-----1------>
<div id="owl-demopodcat5" class="owl-carousel owl-theme owl-new-carl owl-sildet">
<?php $prodcast = prodcast_detail_all("4");
...
<div class="item ite-mazon vedeo_arti_exp">
	<div class="podcast_imges_full">			
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Techies/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>">
	...
	<div class="file_catgroy">
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Techies/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>"><?php echo $prow->prodcast_title; ?></a>
	...
	<div class="podcast_love">
		...
		<div class="pull-right">
			<div class="follr">
                ...
                <label for="heart4"><i class="fa fa-heart-o" aria-hidden="true"></i> <span>0</span></label>
            </div>
		</div>
</div>
...
<a href="<?php echo base_url() ?>Podcast/PodcastList/Techies" class="yesdo1">View	More</a>
...
<div class="row">
	<div class="col-md-12 ">
		...
		<!-----1------>
		<div id="owl-demo41" class="owl-carousel owl-theme owl-new-carl owl-sildet">
		<?php $expert_article = article_detail("4");
		  if($expert_article !=''){
