...
<div class="item ite-mazon vedeo_arti_exp">
	...
	<div class="file_catgroy">
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Lawer/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>"><?php echo $prow->prodcast_title; ?></a>
	...
	<div class="podcast_love">
		...
		<div class="pull-right">
			<div class="follr">
                ...
                <label for="heart3"><i class="fa fa-heart-o" aria-hidden="true"></i> <span>0</span></label>
            </div>
		</div>
</div>
