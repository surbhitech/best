...
<div id="tell<?php echo "2"; ?>" class="tab-pane fade">
...
<div class="row">
	...
	<!-----	<div class=" background1">
		...
		1------>
		<div id="owl-demo33" class="owl-carousel owl-theme owl-new-carl owl-sildet">
			<?php  $expert_detail = expert_detail_incatid("2");
				   $cat_name = cat_name("2");
...
<!----------------recect_video--------------------->
<?php $prodcast = prodcast_detail_all("2");
  if($prodcast !=''){ ?>
...
<!-----1------>
<div id="owl-demopodcat3" class="owl-carousel owl-theme owl-new-carl owl-sildet">
<?php $prodcast = prodcast_detail_all("2");
...
<div class="item ite-mazon vedeo_arti_exp">
	<div class="podcast_imges_full">			
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Doctors/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>">
	...
	<div class="file_catgroy">
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Doctors/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>"><?php echo $prow->prodcast_title; ?></a>
	</div>
	...
	<div class="podcast_love">
		...
		<div class="pull-right">
			<div class="follr">
                ...
                <label for="heart2"><i class="fa fa-heart-o" aria-hidden="true"></i> <span>0</span></label>
            </div>
		</div>
</div>
...
<?php } ?>
<!--Recent Articles -->
<?php $article =  article_detail_all("2");
  if($article !=''){ ?>
...
<div class="row">
	<div class="col-md-12 ">
		...
		<!-----1------>
		<div id="owl-demo35" class="owl-carousel owl-theme owl-new-carl owl-sildet">
		<?php $expert_article = article_detail_all("2");
		...
		<a href="<?php echo base_url() ?>Article/Detail/<?php echo $cat_name; ?>/<?php echo  $subcat_name3; ?>/<?php echo $article->article_id; ?>">
		  <?php  if(file_exists($article->article_image_link)){ ?>  <img src="<?php echo $article->article_image_link; ?>" />  <?php  } else{ ?>
		  <img src="<?php echo $dummy_img; ?>" />
