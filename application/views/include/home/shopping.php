<div id="tell<?php echo "5"; ?>" class="tab-pane fade">
...
<div class="row">
	...
	<!-----	<div class=" background1">
		...
		1------>
		<div id="owl-demo42" class="owl-carousel owl-theme owl-new-carl owl-sildet">
			<?php  $expert_detail = expert_detail_incatid("5");
				   $cat_name = cat_name("5");
...
<?php $prodcast = prodcast_detail_all("5");
  if($prodcast !=''){ ?>
...
<!-----1------>
<div id="owl-demopodcat6" class="owl-carousel owl-theme owl-new-carl owl-sildet">
<?php $prodcast = prodcast_detail_all("5");
...
<div class="item ite-mazon vedeo_arti_exp">
	<div class="podcast_imges_full">			
		<a href="<?php echo base_url() ?>Podcast/SingleDetail/Purchase/<?php echo $subcat_name3 ?>/<?php echo $prow->id ?>">
	...
	<div class="file_catgroy ">
		<a href="<?php echo base_url() ?>Prodcast/Detail/Purchase/<?php echo $cat_name; ?>/<?php echo  $subcat_name3; ?>/<?php echo $prow->id; ?>"><?php echo $prow->prodcast_title; ?></a>
	</div>
	...
	<div class="podcast_love">
		...
		<div class="pull-right">
			<div class="follr">
                ...
                <label for="heart5"><i class="fa fa-heart-o" aria-hidden="true"></i> <span>0</span></label>
            </div>
		</div>
	</span>
</div>
...
<div class="row">
	<div class="col-md-12 ">
		...
		<!-----1------>
		<div id="owl-demo44" class="owl-carousel owl-theme owl-new-carl owl-sildet">
		<?php $expert_article = article_detail("5");
		  if($expert_article !=''){
