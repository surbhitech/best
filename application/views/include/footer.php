	...
	<div class="col-md-2 col-sm-3 col-xs-12 socials">
		<div class="setlink	social_2">
			...
			<ul>
				...
				<li><a href="https://api.whatsapp.com/send/?phone=919997882133&text&app_absent=0"target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"title="Whatapps"></i> </a></li>
...
<div class="col-md-12">
<p class="text-muted"style="color:#fff;">© 2020 <a href="#"style="color:#fff;"> bestadvicer.com</a></p>
...
alert('Your UserId Or Password Incorrect Please Signup Or Forget Password In User Panel'); }
  ...
  function linkswitch(expert_id,link){

             $.ajax({
                          url:"<?php echo base_url(); ?>Ajax_req/set_link_session",
                          method:"POST",
                          data:"expert_id="+expert_id+"&link="+link,
                          success:function(data){
                          	if(data==1){
                          		window.location.assign(link);
                          	} else{ window.location("<?php echo base_url() ?>404_override"); }                     
                             }
                                            });
	}
...
<script>
function article_likers(article_id){
...
function prodcast_likers(prodcast_id){
var base_url = "<?php echo base_url(); ?>";
$.ajax({
url: base_url+"Ajax_req/prodcast_likers",
type: "POST",
data: "prodcast_id="+prodcast_id,
success: function(detail){
if(detail > 0){
$("#like_num_prodcast").html(detail);
}
// $("#likers").append(detail);
}
});
...
<script src="https://bestadvicer.com/assets/js/audioplayer.js"></script>
<script>
$(function() {
$('audio').audioPlayer();
});
