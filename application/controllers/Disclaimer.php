...
class Disclaimer extends CI_Controller { 
	...
	public function view(){
	    ...
	    $data['Disclaimer'] = $this->Main_model->expert_in_subcat($Disclaimer_id);
	    $data['Faq'] = $this->Main_model->expert_in_subcat($faq_id);
	...
	public function Profile(){
	    ...
	    $data['Faq'] = $this->Main_model->subcat_data_single($data['faq_id']);		
	    $data['Disclaimer'] = $this->Main_model->subcat_data_single($data['Disclaimer_id']);		
