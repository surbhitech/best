...
class Copyright extends CI_Controller { 
	...
	public function view(){
	    ...
	    $data['Contactus'] = $this->Main_model->expert_in_subcat($Contactus_id);
	    $data['copyright'] = $this->Main_model->subcat_data_single($copyright);
	...
	public function Profile(){
	    ...
	    $data['copyright'] = $this->Main_model->check_expert($copyright);
	    $data['Contactus'] = $this->Main_model->check_expert($Contactus_id);
