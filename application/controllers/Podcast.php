...
class Podcast extends CI_Controller { 
	...
	public function SingleDetail(){
		...
		$podcast_id = $this->uri->segment('5');
		$data['podcast_detail'] = $this->Main_model->podcast_full_detail($podcast_id);
		$this->load->view('single_podcast_detail',$data);
	}

	public function Viewdetail(){
	    $expert_id = $this->uri->segment('2');
	    $subcat_id = $this->uri->segment('3');
	    $cat_id  = $this->uri->segment('4');
		$data['podcast'] = $this->Main_model->single_podcast_detail($expert_id,$subcat_id,$cat_id);
		$this->load->view('podcast_blog_front',$data);
	...
	public function PodcastList(){
		...
		$this->load->view('podcast_list_details',$data);
	}
	...
	public function Podcast(){
		$subcat_id = $this->uri->segment('3');
		$data['podcast'] = $this->Main_model->podcast_list_details_insubcatwise($subcat_id);
		$this->load->view('podcast_list_details',$data);
	}
   public function subcat_namebysubctaid($subcat_name){
	...
	public function Career(){
		...
		$data['podcast'] = $this->Main_model->podcastdetail_insubcatwise($subcat_id);
		$this->load->view('podcast_blog',$data);
	}
