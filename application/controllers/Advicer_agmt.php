...
class Advicer_agmt extends CI_Controller { 
	...
	public function view(){
	    ...
	    $data['advicer_agmt'] = $this->Main_model->expert_in_subcat($advicer_agmt_id);
	...
	public function Profile(){
	    ...
	    $data['advicer_agmt'] = $this->Main_model->check_expert($advicer_agmt_id);
