...
class Questionataexpertend extends REST_Controller
{
  ...
  */
  ...
  public function index_get(){
	...
	//$data = json_decode(file_get_contents("php://input"));
	$expert_id = $this->security->xss_clean($_GET['expert_id']);
	$advice_mode = $this->security->xss_clean($_GET['advice_mode']);
	if(isset($expert_id) && isset($advice_mode)){
    $expert_question = $this->Question_Api_Model->expertqrow_single($expert_id,$advice_mode);
	} else{
