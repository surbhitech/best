...
class Demo extends CI_Controller { 
	...
	public function pdf_detail(){
	    $this->load->add_package_path( APPPATH . 'libraries/Tcpdf');
	...
	public function view(){
	    ...
	    $data['demo'] = $this->Main_model->demo_name_in_demo($demo_id);
	...
	public function Profile(){
	    ...
	    $data['demo'] = $this->Main_model->demo_data_demo($data['demo_id']);
