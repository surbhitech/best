...
class Sitemap extends CI_Controller { 
	...
	public function view(){
	    ...
	    $data['Search'] = $this->Main_model->expert_in_subcat($Search_id);
	    $data['Sitemap'] = $this->Main_model->expert_in_subcat($Sitemap_id);
	...
	public function Profile(){
	    ...
	    $data['Search'] = $this->Main_model->check_expert($Search_id);
	    $data['Sitemap'] = $this->Main_model->check_expert($Sitemap_id);
