...
class Advicer_terms extends CI_Controller { 
	...
	public function view(){
	    ...
	    $data['advicer_terms'] = $this->Main_model->expert_in_subcat($advicer_terms_id);
	...
	public function Profile(){
	    ...
	    $data['advicer_terms'] = $this->Main_model->check_expert($advicer_terms_id);
