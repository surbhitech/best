...
class Editors_message extends CI_Controller { 
...

	{
		...
		$this->load->view('editors_message');
	...
	public function view(){
	    ...
	    $data['Editors_message'] = $this->Main_model->expert_in_subcat($editors_message_id);
		
	    $data['User_agreement'] = $this->Main_model->expert_in_subcat($User_agreement_id);
	...
	public function Profile(){
	    ...
	    $data['User_agreement'] = $this->Main_model->check_expert($User_agreement_id);
		
	    $data['Editors_message'] = $this->Main_model->check_expert($editors_message_id);
